...
class Usuario(models.Model):
    ...
    sexo_usu = models.CharField(max_length=10, choices=[('masculino', 'Masculino'), ('femenino', 'Femenino'), ('otro', 'Otro')])
...
class Publicacion(models.Model):
    ...
    id_estpubli = models.ForeignKey(Estado_Publicacion, on_delete=models.CASCADE)
...
class Historial_Publicacion(models.Model):
    ...
    prec_ant = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    prec_nue = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
...
class Login(models.Model):
    ...
    est_login = models.CharField(max_length=10, choices=[('exitoso', 'Exitoso'), ('fallido', 'Fallido')])
